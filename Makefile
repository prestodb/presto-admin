.PHONY: clean-all clean clean-eggs clean-build clean-pyc clean-test-containers clean-test \
	...
	clean-test-all smoke-configurable-cluster test-all-configurable-cluster
...
smoke-configurable-cluster: _clean_tmp _smoke
...
test-all-configurable-cluster: _clean_tmp _test-all
