...
from prestoadmin.util.fabricapi import by_role_coordinator
...
class TestFabricapi(BaseTestCase):
    ...
    def test_by_role_coordinator(self):
        ...
        by_role_coordinator('worker0', callback)
        self.assertFalse(callback.called, "coordinator callback called for worker")
        by_role_coordinator('coordinator', callback)
